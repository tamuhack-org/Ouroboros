...
# TODO(jaykhatri): might need this mime thingy.
# RUN set -ex \
#     && RUN_DEPS=" \
#         libpcre3 \
#         mime-support \
...
ENV DJANGO_SETTINGS_MODULE=ouroboros.settings.docker

# Call collectstatic (customize the following line with the minimal environment variables needed for manage.py to run):
RUN /venv/bin/python ouroboros/manage.py collectstatic --noinput
