# Generated by Django 2.2.2 on 2019-07-05 00:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shirt_size', models.CharField(choices=[(None, '-- Select Option --'), ('XS', 'XS'), ('S', 'S'), ('M', 'M'), ('L', 'L'), ('XL', 'XL'), ('XXL', 'XXL')], max_length=3, verbose_name='Shirt size?')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('resume', models.FileField(upload_to='', verbose_name='Upload your resume', help_text='Companies will use this resume to offer interviews for internships and full-time positions.')),
