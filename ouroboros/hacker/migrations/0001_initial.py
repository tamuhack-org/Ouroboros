    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('race', models.CharField(choices=[('American Indian', 'American Indian or Alaskan Native'), ('Asian', 'Asian'), ('Black', 'Black or African-American'), ('Hispanic', 'Hispanic or Latino White'), ('Native Hawaiian', 'Native Hawaiian or other Pacific Islander'), ('White', 'White or Caucasian'), ('Two Races', 'Two or more races'), ('NA', 'Decline to self-identify')], max_length=41, verbose_name='What race do you identify with?')),
                ('classification', models.CharField(choices=[('U1', 'U1'), ('U2', 'U2'), ('U3', 'U3'), ('U4', 'U4')], max_length=2, verbose_name='What classification are you?')),
                ('grad_year', models.IntegerField(choices=[(2019, 2019), (2020, 2020), (2021, 2021), (2022, 2022), (2023, 2023), (2024, 2024)], verbose_name='What is your anticipated graduation date?')),
