    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('adult', models.BooleanField(choices=[(True, 'Yes'), (False, 'No')], default=None, verbose_name='Are you at least 18 or older?')),
                ...
                ('gender', models.CharField(choices=[(None, '-- Select Option --'), ('M', 'Male'), ('F', 'Female'), ('NB', 'Non-binary'), ('NA', 'Prefer not to disclose')], max_length=2, verbose_name="What's your gender?")),
                ...
                ('extra_links', models.CharField(max_length=200, verbose_name="Point us to anything you'd like us to look at while considering your application")),
                ...
                ('resume', models.FileField(help_text='Companies will use this resume to offer interviews for internships and full-time positions.', upload_to='', verbose_name='Upload your resume')),
                ('additional_accommodations', models.TextField(max_length=500, verbose_name='Do you require any special accommodations at the event?')),
