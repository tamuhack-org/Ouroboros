...
QUESTION3_TEXT = f"If given the choice, would you prefer to attend {settings.EVENT_NAME} in-person or virtually? (Note: A virtual option does NOT exist for this hackathon)"
