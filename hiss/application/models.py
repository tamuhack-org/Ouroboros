...
QUESTION3_TEXT = f"If given the choice, would you attend {settings.EVENT_NAME} in-person or virtually? Note: In-person availability is only for the first 200 people who check-in at our venue on the morning of {settings.EVENT_NAME}."
