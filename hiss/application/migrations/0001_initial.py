    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('transport_needed', models.CharField(choices=[(None, '-- Select Option --'), ('drive', 'Driving'), ('th-bus', 'TAMUhack Bus'), ('fly', 'Flying'), ('public', 'Public Transportation'), ('walk-cycle', 'Walking/Biking')], max_length=11)),
