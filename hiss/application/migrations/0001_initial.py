# Generated by Django 2.2.4 on 2019-10-28 22:46
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('grad_term', models.IntegerField(choices=[(2019, 2019), (2020, 2020), (2021, 2021), (2022, 2022), (2023, 2023)], verbose_name='What is your anticipated graduation year?')),
                ...
                ('transport_needed', models.CharField(choices=[('D', 'Driving'), ('B', 'TAMUhack Bus'), ('F', 'Flying'), ('P', 'Public Transportation'), ('M', 'Walking/Biking')], max_length=11, verbose_name='How will you be getting to the event?')),
