...
common_names = [ "Noah", "Liam", "Mason", "Jacob", "William", "Ethan", "Michael", "Alexander", "James", "Daniel", "Emma", "Olivia", "Sophia", "Ava", "Isabella", "Mia", "Abigail", "Emily", "Charlotte", "Harper"]
...
def seed_database(num_of_users: int, num_of_active: int, num_of_applications: int):
    ...
    for e in arr:
        ...
        if e["make_app"]:
            ...
            fake_date_range = datetime.datetime(2019, 9, random.randint(1, 30), 22, 30, 52, 32320, tzinfo=pytz.UTC)
            current_app = Application.objects.create(
                ...
                race = [random.choice(["Asian", "Black", "Hispanic", "Native Hawaiian", "White", "NA", "Other"])],
                classification = random.choice(["Fr", "Fr", "Fr", "Fr", "So", "Jr", "Sr", "Ot"]),
                grad_term = random.choice(['Fall 2019', 'Spring 2020', 'Fall 2020', 'Spring 2021', 'Fall 2021', 'Spring 2022', 'Fall 2022', 'Spring 2023']),
                num_hackathons_attended = random.choice(["0", "0", "0", "1-3", "1-3", "4-7", "8-10", "10+"]),
                previous_attendant = random.choice([True, True, True, True, True, True, True, True, False]),
                tamu_student = True,
                extra_links = 'extra_links',
                question1 = 'question1',
                question2 = 'question2',
                question3 = 'question3',
                approved = random.choice([None, None, None, None, None, None, None, None, None, None, None, None, True, True, True, False]),
                agree_to_coc = True,
                is_adult = True,
            ...
            current_app.save()
            print('Created app', current_app, current_user.email, current_app.datetime_submitted, datetime.datetime(2019, 9, random.randint(1, 30), 22, 30, 52, 32320, tzinfo=pytz.UTC))
